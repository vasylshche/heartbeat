...
- Deep green. Friendly countries for ukraine citizens, almost any zone outside of Ukraine.

## Default configuration for triggers
- Reminders: Monday-Friday, 10a.m. and 3p.m.. Variables: `DAYS`, `HOURS`.
- Inactivity check: Daily, 4p.m. Variables: `EXPIRATION_HOUR`.
...
Notes: zones are used in `locations` variables as well - to create inline keyboard.
...
- Copy spreadsheet id (part of url, `https://docs.google.com/spreadsheets/d/{ID_HERE}/edit`) into `ssid` variable
